...
int main(void)
{
    ...
    for(;;)
    {
        ...
        stepVal = (uint8_t) ADC_DelSig_1_GetResult8();
        ...
        if(stepVal > prev_val) //clockwise motion
        {
            stepper(1,0,0,0,2);
            stepper(0,1,0,0,2);
            stepper(0,0,1,0,2);
        ...
        if(stepVal < prev_val) //counter-clockwise motion
        {
        ...
        prev_val = stepVal;
            ...
            sprintf(lcdOutput,"Val1=%d", (int)mapped_val1);
