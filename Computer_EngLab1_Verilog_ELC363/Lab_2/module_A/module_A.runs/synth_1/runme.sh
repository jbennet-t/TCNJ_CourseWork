...
HD_PWD='E:/ELC363-Lab/Lab_2/module_A/module_A.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ripple_adder_64.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ripple_adder_64.tcl
