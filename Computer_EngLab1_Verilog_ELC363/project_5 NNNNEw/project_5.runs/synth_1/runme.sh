...
HD_PWD='C:/Users/sinow/Documents/ELC363-Lab/project_5 NNNNEw/project_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ARM_CPU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ARM_CPU.tcl
