...
namespace XILINX_DPI { 
	...
	void dpiInitialize()
	{
		...
		DPISetCallerName(0, "C:/Users/sinow/Documents/VLSI/DC_Removal/DC_Removal.srcs/sim_1/new/DCR_tb.sv") ;
		DPISetCallerLine(0, 67) ;
		DPISetCallerOffset(0, 2720) ;
		DPIAllocateDPIScopes(1) ;
		DPISetDPIScopeFunctionName(0, "sin") ;
		DPISetDPIScopeHierarchy(0, "math_pkg") ;
		DPIRelocateDPIScopeIP(0, (char*)(0x3380)) ;
	}
