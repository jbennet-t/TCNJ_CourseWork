...
namespace XILINX_DPI { 
	...
	void dpiInitialize()
	{
		...
		DPISetCallerName(0, "C:/Users/sinow/Documents/VLSI/SoundEffectBoard_VLSI/SoundEffectBoard_VLSI.srcs/sim_1/new/distortion_tb.v") ;
		DPISetCallerLine(0, 58) ;
		DPISetCallerOffset(0, 1904) ;
		DPIAllocateDPIScopes(1) ;
		DPISetDPIScopeFunctionName(0, "sin") ;
		DPISetDPIScopeHierarchy(0, "math_pkg") ;
		DPIRelocateDPIScopeIP(0, (char*)(0x2750)) ;
	}
